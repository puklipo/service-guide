...
本稿では、障害福祉サービス事業所の定員数（キャパシティ）に焦点を当て、事業規模別の分布と、サービス種別ごとの平均定員数を分析します。[2023年9月](/articles/202309/05-capacity-analysis)データとの比較も交え、これにより市場の供給構造とサービス提供の特性を明らかにします。

...
```blade
<x-chart.bar
  :data="[66.2, 8.0, 16.5, 45.5]"
  :labels="['株式会社', '社会福祉法人', 'NPO法人', 'その他']"
  title="法人形態別の長期成長率（2021年11月～2025年3月、%）"
/>
```
...
<x-chart.pie
  :data="[39.1, 31.2, 29.7]"
  :labels="['大規模事業者（10施設以上）', '中規模事業者（3～9施設）', '小規模事業者（1～2施設）']"
  title="事業規模別の市場構成比（2025年3月、%）"
/>
```
...
```blade
<x-chart.bar
  :data="[[91.3, 87.5, 82.1], [78.5, 72.3, 67.8]]"
  :labels="['大規模事業者', '中規模事業者', '小規模事業者']"
  title="規模別の平均利用率と職員定着率（2025年3月、%）"
/>
```

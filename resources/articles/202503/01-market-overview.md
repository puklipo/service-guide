...
2. **放課後等デイサービス**: 22,489施設（11.4%）【前回比+664施設、+3.0%成長】
3. **重度訪問介護**: 20,611施設（10.4%）【前回比+391施設、+1.9%成長】
4. **就労継続支援B型**: 18,058施設（9.1%）【前回比+325施設、+1.8%成長】
5. **共同生活援助**: 14,428施設（7.3%）【前回比+283施設、+2.0%成長】

前回と比較して、上位5サービスの順位に若干の変化が見られます。放課後等デイサービスが重度訪問介護を抜いて第2位となっており、児童向けサービスの需要が引き続き強いことを示しています。また、上位サービスの成長率は1.8%～3.0%と市場全体の成長率（3.5%）に近いか下回っており、これは市場の成熟化と新興サービスへの注目の高まりを示唆しています。
...
4. **就労継続支援B型**: +1.8%（18,058施設、前回17,733施設）
...
1. **施設系サービス**: 105,191施設（53.2%）
   - **総定員数**: 1,329,969名
   - 代表的サービス: 生活介護、放課後等デイサービス、就労継続支援B型

2. **訪問系サービス**: 60,648施設（30.7%）
   - 代表的サービス: 居宅介護、重度訪問介護、同行援護

3. **相談系サービス**: 28,862施設（14.6%）
   - 代表的サービス: 計画相談支援、障害児相談支援

4. **支援系サービス**: 3,007施設（1.5%）
...
|-----------|------------|-------|------------|
| 施設系サービス | +3,068施設 | +3.0% | 児童系サービスの継続的成長 |
| 訪問系サービス | +1,475施設 | +2.5% | 安定した成長を維持 |
| 相談系サービス | +1,775施設 | +6.6% | 連携・調整系の支援の需要急増 |
| 支援系サービス | +441施設 | +17.2% | 自立生活・就労定着の重視 |

相談系サービスと支援系サービスが高い成長率を示している一方、訪問系・施設系サービスは市場平均より低い成長となっています。これは、サービスを提供するだけでなく、それらを効果的に組み合わせて利用者の自立を支援するコーディネーション機能の重要性が高まっていることを示しています。
...
長期的に見ると、株式会社と「その他」の法人形態の伸びが顕著で、特に合同会社や一般社団法人などの形態が急増しています。これは、規制緩和や参入障壁の低下、多様な経営主体による市場参入の結果と考えられます。一方、社会福祉法人は安定した成長を続けていますが、市場シェアとしては相対的に低下傾向にあります。
...
*本分析は2025年3月時点のWAMデータに基づき、2024年9月との比較により市場動向を分析したものです。全ての数値は公開データを基に算出しており、一部推計を含みます。本記事が事業者の皆様の市場理解と戦略検討に寄与することを願っています。*

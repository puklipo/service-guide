...
### 基本統計
- **総事業所数**：121,355事業所
- **総定員数**：708,947人（定員のあるサービスのみ）
- **定員のある事業所数**：38,584事業所
- **平均定員数**：18.4人（定員のあるサービスのみ）

### 定員規模別分布
- **小規模（1-10人）**：65.1%（25,118事業所）
- **中規模（11-30人）**：17.3%（6,657事業所）
- **大規模（30人以上）**：17.6%（6,809事業所）

### サービス分類別定員特性
- **訪問系サービス**：定員制限なし（47,508事業所）
- **施設系サービス**：708,947人の総定員（38,584事業所）
- **相談支援サービス**：定員制限なし（15,806事業所）

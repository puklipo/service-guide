...
4. **児童発達支援**: +4.9%（8,680施設→9,109施設）

#### 安定成長サービス（成長率2-4%）
1. **放課後等デイサービス**: +3.9%（14,663施設→15,229施設）
2. **共同生活援助**: +3.7%（10,012施設→10,386施設）
3. **就労定着支援**: +3.2%（1,234施設→1,273施設）
4. **障害児相談支援**: +2.5%（6,462施設→6,624施設）
